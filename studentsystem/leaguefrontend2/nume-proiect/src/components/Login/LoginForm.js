    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <h2 className="text-2xl font-bold text-center mt-4 text-red-700" style={{ color: '#333', opacity: 1 }}>Login</h2>
                <form onSubmit={handleSubmit} className="mt-4">
                    ...
                    <div className="mb-4 relative">
                        <label className="block text-gray-800">Parolă</label>
                        <input
                ...
                <div className="text-center mt-4">
                    <NavLink to="/register" className="text-blue-600 hover:underline">Don't have an account? Sign Up</NavLink>
                </div>
            </div>
        </div>
    );
